...
(function(){
  ...
  function routeLabel(route){
    return route === 'INDORE_SURAT' ? 'Indore to Surat' : 'Nashik to Surat';
  }
  ...
  function validateStep1(){
    ...
    setInvalid('f-route', route === 'NASHIK_SURAT' || route === 'INDORE_SURAT');
  ...
  function collectBooking(){
    ...
    return {
      ...
      travelDate: $('travelDate').value,
      boardingPoint: route === 'INDORE_SURAT' ? $('boardingNagar').value : 'Nashik',
      droppingPoint: 'Surat',
      totalAmount: total,
      amountPaid: paid,
